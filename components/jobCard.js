    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.container2}>
        <Text style={styles.headText}>
          Senior Associate of Strategy of Operations,Daraz
        </Text>
        <Text style={styles.secondaryText}>eCommerce Verticals</Text>
        <Image
          source={require("../assets/Daraz.png")}
          style={{ height: 40, width: 70, marginTop: 10 }}
        />
        ...
        <View style={styles.container2}>
          ...
          <Text style={styles.secondaryText3}>
            Daraz is the leading e-commerce marketplace across South Asia
            (excluding India). Our business covers four key areas – e-commerce,
            logistics, payment infrastructure and financial services – providing
            our sellers and customers with an end-to-end commerce solution.
          </Text>
        </View>

<View style={[styles.container2 , {flexDirection:'row',marginTop:60}]}>

<TouchableOpacity style={styles.button} onPress={() => navigation.navigate("jobCard2")}  > 
